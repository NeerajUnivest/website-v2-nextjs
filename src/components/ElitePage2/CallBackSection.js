...
export default function CallBackSection() {
    return (
        <section style={{ background: 'linear-gradient(180deg, rgba(243, 247, 249, 0.00) -6.26%, #E4EFF2 43.54%, rgba(243, 247, 249, 0.00) 104.34%' }} className="flex flex-col items-center gap-4 px-4 py-8">
            <Image className="w-20" src={callbackIcon} alt="demo" />
            <div className="flex flex-col justify-center items-center gap-3">
                <p>Connect with wealth advisor</p>
