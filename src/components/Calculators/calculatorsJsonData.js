...
const calcData = [
    {
        ...
        extraDetails: [
            ...
            },
            {
                ...
                answer: '<p>Generally, there are seven types of Systematic Investment Plans(SIPs), which have been explained below:</p> <p>&nbsp;</p> <ul class="list-disc list-outside pl-4" > <li>Regular SIP: Regular SIPs are one of the most convenient types of SIPs where a fixed amount is invested on a regular basis for the desired investment period. The duration of investment may be monthly, quarterly, or half-yearly.&nbsp;</li> <li>Top-up SIP: In this type of SIP, the amount of SIP contribution can be increased periodically, as per the investor&rsquo;s convenience and financial capacity.</li> <li>Flexible SIP: Flexible SIPs provide the flexibility to make alterations to your SIP investment plan. These changes can be in terms of the SIP amount or even the frequency of investment. A flexible SIP helps to increase or decrease the SIP contributions based on market conditions.&nbsp;</li> <li>Trigger SIP: These SIPs are for experienced investors who are well aware of the market risks and are comfortable investing during volatile market conditions. It is imperative to note that one must have adequate knowledge and understanding of the market trends to invest in Trigger SIP.</li> <li>Perpetual SIP: Perpetual SIP is similar to regular SIP, the only difference being that of a fixed investment tenure. In this type of SIP, one needs to keep investing until the fund house is requested to stop the SIP.&nbsp;</li> <li>Multi SIP: Multi SIPs help in the diversification of the funds invested as the money is invested in various sectors. Such diversification allows the risk to be mitigated.</li> <li>SIP with Insurance: If an investor is opting for long-term SIP, then some asset management companies provide insurance coverage as an additional benefit. The coverage amount may vary as per the amount invested through SIP. However, this scheme is provided only in the case of equity mutual funds.</li> </ul> <p><br></p> <p><br></p>',
            },
            {
                question: "Investment process in SIPs",
                answer: '<ul class="list-disc list-outside pl-4"> <li>To begin investing in SIPs, one must choose a mutual fund that aligns with the personal interest of the investor. Some necessary factors to consider before the selection include the financial goals and investment tenure of the SIP. Additionally, the mutual fund should be chosen in accordance with the risk tolerance capacity of the investor. Higher risk can lead to significantly higher returns. However, since many investors are risk-averse, they might prefer mutual funds with comparatively lower risk.</li> <li>Once the suitable mutual fund scheme is selected, the investor must decide a fixed amount to be invested regularly, along with the date of investment. This amount is generally invested every month by most investors. Moreover, the SIP amount has no mandates and can be fixed as per the investor&rsquo;s financial threshold. One can even start a SIP from an amount as low as Rs. 500.</li> <li>After these steps are completed, the SIP investment has been done and the amount will be deducted automatically from the linked bank account of the investor.</li> </ul>',
            },
            {
                question: "Advantages of SIPs in long-term investments",
                answer: '<ul class="list-disc list-outside pl-4"> <li>Exponential Growth:The foremost advantage of investing in Systematic Investment Plans from a long-term perspective is that an investor can exponentially grow his wealth due to the benefit of compounding. In simpler terms, &lsquo;Benefit of Compounding&rsquo; means that the returns earned from the SIP are reinvested in the SIP mutual fund scheme, which increases the principal amount of investment, thus leading to higher future potential returns.&nbsp;</li> <li>Disciplined Investment Habit: Investing in SIPs promotes discipline among investors by inculcating a regular habit of saving every month. Since the SIP amount to be deducted regularly is predetermined, individuals can plan their finances better by reducing unnecessary expenses. This helps in effective personal finance management, while simultaneously contributing smaller amounts for a good amount of target corpus.</li> <li>Navigating fluctuations in market trends:Since SIPs follow the principle of Rupee Cost Averaging, investors can easily adapt to market fluctuations. Owing to this principle, more units are allotted when there is a downturn in the market and vice-versa.</li> <li>Tax Deductions:Various mutual fund schemes offer tax deduction benefits under Section 80C of the Income Tax Act. Professional Management:</li> </ul>',
            },
            {
                question: "SIP Calculator",
                answer: '<p><span style="font-weight: 400;">A SIP Calculator is a financial tool available online that assists investors in calculating a close estimate of the returns on investments made in Mutual Funds via SIPs, that is, </span><a href="https://www.nseindia.com/products-services/nmf-systematic-investment-plan"><span style="font-weight: 400;">Systematic Investment Plans</span></a><span style="font-weight: 400;">. Over and above, it also helps in the calculation of the SIP amount required to be invested each month to achieve the target corpus of an investor. To calculate the estimated returns, the SIP Calculator takes into account the monthly investment amount and the duration of the investment. However, the actual returns of SIPs may vary due to fluctuations in market trends and other relevant factors. For beginner-level investors who aren&rsquo;t well-versed with the investment process of SIPs, or lack clarity concerning the returns they would be earning from their mutual fund portfolio, SIP calculators are a reliable source to help them estimate their returns, which otherwise would have been a complex calculation if done manually.</span></p> <p><span style="font-weight: 400;">Investors who want to check the SIP returns when they top up their mutual fund investment can also use </span><strong>SIP top-up calculators</strong><span style="font-weight: 400;"> available online. It will provide a better understanding of the expected return on SIPs.</span></p>',
            },
            {
                question: "Components of SIP Calculator",
                answer: '<p><span style="font-weight: 400;">A SIP Calculator essentially requires four main details for the purpose of estimation of returns. These are:</span></p> <ol class="list-disc list-outside pl-4"> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Amount of Investment</span></li> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Tenure of Investment</span></li> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Frequency of Investments to be made</span></li> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Expected Rate of Return on the Investments Done</span></li> </ol>',
            },
            {
                question: "Benefits of using a SIP Calculator ",
                answer: '<p><span style="font-weight: 400;">A SIP mutual fund calculator helps investors in various ways such as:</span></p> <ol class="list-decimal list-outside pl-5"> <li><span style="font-weight: 400;"> Estimation of the Returns: </span>As the name suggests, the primary advantage of using a SIP calculator is that it allows the investors to estimate the potential returns they can earn from their portfolio of SIP mutual fund schemes. This will help them make informed investment decisions so they can align their financial goals accordingly.</li> <li><span style="font-weight: 400;"> User-Friendly Interface: </span>Only a few details are required as input to determine the SIP returns, such as the amount of SIP, rate of return and the tenure of investment. This makes the interface easy to use as there are no technical terms required for the calculation of SIP returns, thus enabling all individuals to make use of it.</li> <li><span style="font-weight: 400;"> Better decision making:</span>There are some of the <strong style="font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;">best SIP calculators</strong><span style="font-weight: 400;"> available online that help you estimate your returns on SIP, thus assisting in better investment decisions.</span></li> <li><span style="font-weight: 400;"> Comparison of SIPs: </span>SIP calculators allow investors to compare the various SIP schemes available, thus helping them to make appropriate choices based on their goals and convenience.</li> </ol>',
            },
            {
                question: "How It Works?",
                answer: '<p><strong>How to Use the SIP Calculator:</strong></p> <p><span style="font-weight: 400;">Estimated amount of returns = Principal amount invested * [(1+ Rate of Interest)*Frequency of Investment-1]/(1= rate of Interest)</span></p> <p><strong>Step-by-Step guide:</strong></p> <p><span style="font-weight: 400;">To use the SIP calculator, follow the below-mentioned steps:</span></p> <p><span style="font-weight: 400;">a.) Open a SIP calculator on your mobile or laptop.</span></p> <p><span style="font-weight: 400;">b.) Enter the required details including the amount you want to invest in the SIP, the tenure of investment and the frequency at which you would like to invest (intervals).</span></p> <p><span style="font-weight: 400;">c.) Set the Rate of Interest.</span></p> <p><span style="font-weight: 400;">d.) Once all the details have been entered, click &ldquo;Proceed/Calculate&rdquo;.</span></p> <p>&nbsp;</p> <p><span style="font-weight: 400;">Following these, the expected return on your SIP investment will be reflected on your screen.</span></p>',
            },
            {
                question: "Tips for maximizing returns from SIPs",
                answer: '<ol class="list-decimal list-outside pl-5"> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Increasing SIP amounts:</span>By dedicating more amounts to the SIP mutual fund scheme, investors can exponentially maximise their invested funds with the help of the Rupee Cost-Averaging principle.</li> <li style="font-weight: 400;" aria-level="1">Preventing withdrawals: <span style="font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;">Unless urgently required, prefer not to withdraw your funds early as this will reduce the principal amount and thus, a smaller portfolio.</span></li> <li style="font-weight: 400;" aria-level="1">Regular Portfolio Reviewing:<span style="font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;">Once invested in a SIP Mutual fund, it is imperative to keep track of the portfolio performance. In case a mutual fund has been underperforming consistently for the past few years, consider withdrawing your funds from it and investing the funds in a top-performing mutual fund instead.</span></li> <li style="font-weight: 400;" aria-level="1">Invest despite market fluctuations:<span style="font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Segoe UI", "Helvetica Neue", sans-serif;">Sometimes the market might take a downturn, leading you to stress about the risks associated with the invested funds. However, take advantage of such fluctuations by purchasing more units of the fund. It is important to note that the risk taken must be calculated and in accordance with your risk appetite.</span></li> <li style="font-weight: 400;" aria-level="1">Invest for the long term:<span style="font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;">Systematic Investment Plans are often beneficial for longer tenures of investment. It is advised to consider investing in SIPs from a long-term perspective rather than prioritising short-term gains.</span></li> </ol>',
            },
            {
                question: "Investment Strategies",
                answer: '<p><span style="font-weight: 400;">Strategies for different investor profiles:</span></p> <p><span style="font-weight: 400;">Since all individuals have differing risk tolerance, their investment strategy has to be different too. Following are some of the common strategies implemented by various investor profiles:</span></p> <p><strong>Risk averse investors:</strong></p> <ul class="list-disc list-outside pl-4"> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Since such types of investors prefer lower risk, they can consider investing in Large-Cap equity funds as those have a stable track record.</span></li> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">They should prefer investing in funds with a positive historical performance to be rest assured.</span></li> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Investment in stocks with fixed-income assets can be a safe choice for risk-averse investors.</span></li> </ul> <p><strong>Investors with moderate risk capacity</strong></p> <ul class="list-disc list-outside pl-4"> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Investors having moderate tolerance of risk must include a balance of small-cap, mid-cap and large-cap funds to ensure stability while including a moderate level of risk.</span></li> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Reviewing the portfolio and reinvesting in case of any potentially higher risks can also be a safe decision.</span></li> </ul> <p><strong>Risk tolerant investors</strong></p> <ul class="list-disc list-outside pl-4"> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Since they have a high level of risk tolerance, they can consider investing more in small-cap funds and aim for maximised growth potential.</span></li> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">They can even consider investing in international funds,</span></li> </ul>',
            },
            {
                question: "Risk management in SIP investments",
                answer: '<p><span style="font-weight: 400;">Investments always have some risks associated with them. While these risks can not be completely eliminated, they can be managed by:</span></p> <ol class="list-decimal list-outside pl-5"> <li style="font-weight: 400;" aria-level="1"><span style="font-weight: 400;">Awareness of Market Trends:</span>To ensure risk minimization, investors must ensure that they stay well informed of the fluctuating trends in the market, and make required decisions accordingly.</li> <li style="font-weight: 400;" aria-level="1">Mindful Selection of Mutual Fund: <span style="font-family: -apple-system, BlinkMacSystemFont,  Roboto, Oxygen, Ubuntu, Cantarell,   sans-serif;">The most important factor to manage risk is to choose a mutual fund scheme with risk as per one&rsquo;s risk tolerance. For risk-averse investors, it is preferable to invest in mutual funds with lower levels of risk. Moreover, one must analyse the past performance of the fund to have a better outlook of the fund before investing.</span></li> <li style="font-weight: 400;" aria-level="1">Diversification is the key:<span style="font-family: -apple-system, BlinkMacSystemFont,  Roboto, Oxygen, Ubuntu, Cantarell,   sans-serif;">Diversify your portfolio by investing in different sectors or asset classes. This is because if one sector is underperforming, another sector might be performing well, thus offsetting the losses.</span></li> <li style="font-weight: 400;" aria-level="1">Seeking Professionals: <span style="font-family: -apple-system, BlinkMacSystemFont,  Roboto, Oxygen, Ubuntu, Cantarell,   sans-serif;">If you are unable to make informed decisions regarding your investment strategy, you might consider seeking advice from finance experts who have more knowledge and experience for effective guidance.</span></li> </ol>',
            },
            {
                question: "Conclusion",
                answer: '<p><span style="font-weight: 400;">In conclusion, Systematic Investment Plans (SIP) can provide numerous benefits to beginner-level investors as well as experienced investors. Investment in SIPs can help individuals achieve various goals by maximising their wealth with small yet regular contributions for a longer tenure of investment. Depending on one&rsquo;s financial goals, risk appetite, and time horizon, one can choose suitable SIP plans that align with his preferences. With its immense convenience, the evolution of SIPs has brought about a phenomenal change in the investment patterns of investors as they move ahead towards a financially secure future!</span></p>',
            }
        ],
        faqs: [
            {
