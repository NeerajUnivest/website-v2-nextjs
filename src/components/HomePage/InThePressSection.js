...
{
    logo: 'https://www.vccircle.com/VCC-logo.svg',
...
{
    logo: 'https://www.financialexpress.com/wp-content/themes/ie-network-theme/assets/src/img/logo/financialexpress.svg',
...
{
    logo: 'https://images.yourstory.com/logos/svg/logo_yourstory.svg',
            ...
            <div className='max-w-screen-xl mx-auto px-4 lg:px-8' ref={ref}>
                ...
                <Marquee
                    ...
                    <div className='flex overflow-y-auto gap-x-14 lg:gap-x-40 pt-10 lg:pt-20 mx-10'>
                        ...
                        {newsList
                            .map((ele, i) =>
                                <Image key={i} src={ele.logo} width='40' height='40' className='h-7 lg:h-10 w-auto object-contain' alt='icon' />
                            )}
                    </div>
                </Marquee>
            </div>
