                                        ...
                                        <div className=" h-full flex flex-col mx-2 gap-2 md:gap-4">
                                            <div className=" border-l-[1px] border-r-[1px] border-b-[1px] rounded-bl-xl rounded-br-xl border-[#BADDFA]  mt-0">
                                                <div className={`flex flex-row items-center justify-center gap-[4px] py-[2px] ${ele?.term === 'FUTURES' ? 'pr-3' : ''} `}>
                                                    ...
                                                    <p className={` ${ele.term === 'SHORT' ? 'text-[#B43C30]' : (ele.term === 'LONG' ? 'text-[#005251]' : (ele.term === 'MEDIUM' ? 'text-[#00439D]' : 'text-[#84026F]'))} text-[10px] md:text-base not-italic font-semibold leading-4`} > {ele?.term === 'SHORT' ? 'Short' : (ele?.term === 'MEDIUM' ? 'Medium' : (ele?.term === 'LONG' ? 'Long' : 'Future'))} {ele?.term === 'FUTURES' ? '' : 'Term'} </p>
                                                    {!ele?.newTradeCard &&
