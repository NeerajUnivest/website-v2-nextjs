...
export default function BenefitsSection() {
    ...
    return (
        <div className="w-full font-Inter flex flex-col justify-center items-start gap-4 border border-[color:var(--neutral-600,#747474)] p-2 rounded-xl border-solid bg-[#363636]">
